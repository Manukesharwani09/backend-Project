...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, true, "Account details updated successfully", user)
    );
});
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, true, "User avatar updated successfully", user));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, true, "User cover image updated successfully", user)
    );
});
...
const getWatchHistory = asyncHandler(async (req, res) => {
  // Logic to get watch history for the user
